...
<link rel="shortcut icon" href="hack-lg.ico" type="image/x-icon">
  ...
  <section class="custom-services-section ftco-section services-section img" style="background-image: url(images/24ft.jpg);">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services services-2" style="background-color: #333; border-radius: 10px;">
						<div class="media-body py-md-4 text-center">
							<div class="icon d-flex align-items-center justify-content-center" style="background-color: #ff9900; color: #fff;"><span class="flaticon-route"></span></div>
				...
				<div class="col-md-3 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services services-2" style="background-color: #333; border-radius: 10px;">
						<div class="media-body py-md-4 text-center">
							<div class="icon d-flex align-items-center justify-content-center" style="background-color: #0099cc; color: #fff;"><span class="flaticon-select"></span></div>
				...
				<div class="col-md-3 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services services-2" style="background-color: #333; border-radius: 10px;">
						<div class="media-body py-md-4 text-center">
							<div class="icon d-flex align-items-center justify-content-center" style="background-color: #ff6699; color: #fff;"><span class="flaticon-rent"></span></div>
				...
				<div class="col-md-3 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services services-2" style="background-color: #333; border-radius: 10px;">
						<div class="media-body py-md-4 text-center">
							<div class="icon d-flex align-items-center justify-content-center" style="background-color: #33cc33; color: #fff;"><span class="flaticon-review"></span></div>
					...
					<div class="carousel-testimony owl-carousel ftco-owl">
						<div class="item">
							<div class="testimony-wrap text-center py-4 pb-5">
								...
								<div class="text pt-4">
									<p class="mb-4">Youll have an amazing experience leasing Vehicles with Our company. Our  services are top-notch!</p>
						...
						<div class="item">
							<div class="testimony-wrap text-center py-4 pb-5">
								...
								<div class="text pt-4">
									<p class="mb-4">The box trucks offered by this company are exceptional. They helped streamline our supply chain operations.</p>
						...
						<div class="item">
							<div class="testimony-wrap text-center py-4 pb-5">
								...
								<div class="text pt-4">
									<p class="mb-4">Working with this company's box truck leasing experts has been a game-changer for our business.</p>
						...
						<div class="item">
							<div class="testimony-wrap text-center py-4 pb-5">
								...
								<div class="text pt-4">
									<p class="mb-4">Their box truck leasing solutions have significantly improved our efficiency and cost-effectiveness.</p>
						...
						<div class="item">
							<div class="testimony-wrap text-center py-4 pb-5">
								<div class="user-img mb-4" style="background-image: url(images/emily.jpg)">
								</div>
								<div class="text pt-4">
									<p class="mb-4">I'm impressed with their dedication and expertise in box truck leasing.</p>
			...
			<div class="row no-gutters">
				...
				<div class="col-md-6 wrap-about py-md-5 ftco-animate">
					<div class="heading-section mb-5 pl-md-5">
						...
						<p>We are your trusted partner for all your box truck leasing needs. With a fleet of 14ft, 16ft, 20ft, 24ft, and 26ft straight box trucks, we provide flexible leasing options starting at just $19.99 per day.</p>
	
						<p>Our mission is to make it easy for you to rent a truck for your business or personal use. Whether you need a box truck for moving, transportation, or any other purpose, we have the perfect vehicle for you.</p>
	
						<p>Explore our selection of box trucks and find the one that suits your needs. Contact us today to start your leasing journey with Hack Solutions USA.</p>
